...
const author: Author = {
  name: 'yang',
  bio: '热爱编程',
  avatar: '/images/avatar.jpg', // 头像路径：放在 public/images/ 目录下
  // email: 'hello@example.com',
  github: 'https://github.com/ALSKDJFHGG',
  // twitter: 'https://twitter.com/yourusername',
};

export default function Profile() {
  return (
    <aside className="bg-white rounded-xl shadow-sm p-6 border border-slate-100">
      <div className="text-center">
        ...
        <p className="text-sm text-slate-600 mb-4">{author.bio}</p>
      </div>
      ...
      <div className="space-y-3">
        ...
        {author.email && (
          <a
            ...
            className="flex items-center gap-3 px-4 py-2.5 rounded-lg hover:bg-slate-50 transition-colors text-slate-700 hover:text-blue-600"
          >
            <svg
              className="w-5 h-5"
              fill="none"
